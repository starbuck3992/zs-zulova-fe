    ...
    >
      ...
      >
        <div class="flex h-40 shrink-0 items-center mt-2 mb-2">
          ...
          >
            <div class="rounded-full bg-white w-7 h-7 flex items-center justify-center mx-auto">
              <a
            ...
            <div class="rounded-full bg-white w-7 h-7 flex items-center justify-center mx-auto mt-5">
              <a
                class="p-2 text-blue-600 hover:text-blue-200 mx-auto text-center block w-fit "
