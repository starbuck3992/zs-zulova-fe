            ...
            <li v-for="item in menuItems" :key="item.label">
                <Disclosure as="div" class="mt-2">
                    <DisclosureButton
                        ...
                        <span>
                            <!-- Když položka nemá submenu ani menu items, renderujeme nuxt-link. V opačném případě renderujeme pouze label. -->
                        ...
                        <span v-if="Array.isArray(item.submenu) || Array.isArray(item.menu_items)">
